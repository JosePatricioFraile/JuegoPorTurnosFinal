...
public class Caballero extends Personaje implements AtributosCaballero{
    ...
    public void siguienteMovimiento(Personaje enemigo) {
        ...
        switch (eleccion){
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println(Caballero.this.getNombre() + " ha usado subir armadura");
